# dnaPipeTE mass accounting: final 18-species panel
...
- Species included: 18 (exactly `te_genome_primary_mediumplus`).
- Species outside that panel, including *D. orestes*, are not processed into this corrected analysis branch.
- Median order-level unresolved fraction: 5.171%.
- Order-level unresolved range: 3.548%–6.179%.
- Median superfamily-level unresolved fraction: 19.995%.
- Recomputed retained-order composition matches the historical relative table within 7.105e-15 percentage points.

For *D. fuscus* (`SRX20497025`), order-level retained mass is 95.742% and unresolved mass is 4.258% of dnaPipeTE aligned repeat bases.
