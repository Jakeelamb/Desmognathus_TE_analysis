...
Legacy note:
This script is for older standalone figure-generation workflows and is not the
canonical source of the repo-level diversity summary tables used downstream in
the current Desmognathus TE analysis.
"""
